...
const SotfSkill = () => {
  ...
  >
    <div className="flex flex-col gap-4">
      ...
      Las habilidades blandas son aquellas capacidades relacionadas con la puesta en práctica de aptitudes comunicacionales y sociales en el entorno laboral que impulsan la inteligencia emocional, más allá de las capacidades técnicas
      </p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="flex flex-col gap-2">
        ...
        <h3 className="text-[20px] font-bold">Comunicación</h3>
      ...
      <div className="flex flex-col gap-2">
        ...
        <h3 className="text-[20px] font-bold">Trabajo en equipo</h3>
        <p className="text-gray-500">
          Sometimes features require a short description
        </p>
      </div>
      <div className="flex flex-col gap-2">
        <RiSmartphoneFill className="text-4xl p-2 bg-secondary text-primary box-content rounded-xl" />
        <h3 className="text-[20px] font-bold">Adaptación al cambio</h3>
        <p className="text-gray-500">
          Sometimes features require a short description
        </p>
      </div>
      <div className="flex flex-col gap-2">
        <RiMacFill className="text-4xl p-2 bg-secondary text-primary box-content rounded-xl" />
        <h3 className="text-[20px] font-bold">Gestión del tiempo</h3>
        <p className="text-gray-500">
          Sometimes features require a short description
        </p>
      </div>
